...
const notices: Notice[] = [
  {
    ...
    content:
      "আগামী ঈদুল ফিতর উপলক্ষে মাদ্রাসা ৭ দিন বন্ধ থাকবে। ছুটির পর ক্লাস নিয়মিত হবে।",
    type: "holiday",
    priority: "high",
    targetAudience: "all",
  ...
  },
  {
    ...
    content:
      "বার্ষিক পরীক্ষা ২০২৪ এর রুটিন প্রকাশিত হয়েছে। সকল শিক্ষার্থী নোটিশ বোর্ড দেখে নিবেন।",
    type: "exam",
    priority: "high",
  ...
  },
  {
    ...
    content:
      "আগামী শুক্রবার বিকাল ৩টায় অভিভাবক সভা অনুষ্ঠিত হবে। সকল অভিভাবকদের উপস্থিত থাকার জন্য অনুরোধ করা হচ্ছে।",
    type: "event",
    priority: "medium",
  ...
  },
  {
    ...
    content:
      "আরবি ও ইসলামিক স্টাডিজ বিভাগ��� নতুন শিক্ষক নিয়োগের জন্য আবেদন আহ্বান করা হচ্ছে।",
    type: "general",
    priority: "medium",
    targetAudience: "all",
...
router.post("/notices", (req, res) => {
  const { title, content, type, priority, targetAudience, expiryDate } =
    req.body;
