    ...
    <div className="min-h-screen bg-gradient-to-br from-islamic-green via-islamic-blue to-islamic-green-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link
            to="/"
            className="inline-flex items-center text-white hover:text-islamic-gold transition-colors mb-4"
          >
        ...
        <Card className="shadow-2xl border-0">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold text-gray-900 font-bengali-heading">
              লগইন করুন
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleLogin}>
              ...
              <div className="space-y-2">
                <Label htmlFor="userType" className="font-bengali">
                  ব্যবহারকারীর ধরন
                </Label>
