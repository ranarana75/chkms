...
const SystemDashboard: React.FC = () => {
  const [systemModules] = useState<SystemModule[]>([
    {
      ...
      features: ['প্রো��াইল ম্যানেজমেন্ট', 'উপস্থিতি ট্র্যাকিং', 'মার্কস এন্ট্রি', 'ফি ম্যানেজমেন্ট']
    },
    {
      id: 'teacher',
      name: 'শিক্ষক পোর্টাল',
    ...
    },
    {
      ...
      features: ['পরীক্ষার সময়সূচি', 'প্রশ্নপত্র তৈরি', 'ফলাফল প্রস্তুতি', 'রিপোর্ট ক��র্ড']
    },
    {
      id: 'admission',
    ...
    },
    {
      ...
      features: ['নোটিশ প্রকাশ', 'জরুরি ঘোষণা', 'টার্গেটেড মেসেজিং', 'অটো এক্সপায়ার']
    },
    {
      id: 'calendar',
      ...
      version: '1.4.0',
      lastUpdated: '2024-12-10',
      description: 'একাডেমিক ক��যালেন্ডার এবং ইভেন্ট পরিকল্পনা',
    ...
    },
    {
      ...
      features: ['বুক ক্যাটালগ', 'ইস্যু-রিটার্��', 'ওভারডিউ ট্র্যাকিং', 'ফাইন ক্যালকুলেশন']
    },
    {
      id: 'hostel',
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>সিস্টেম মডিউলসমূহ</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">১২টি মডিউল সফলভাবে চলমান</p>
            </div>
            <div className="text-center">
