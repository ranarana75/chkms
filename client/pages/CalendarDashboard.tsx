      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              একাডেমিক ক্যালেন্ডার এবং ইভেন্ট ব্যবস্থাপনা
            </p>
          </div>
          <div className="flex space-x-2">
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewEvent({ ...newEvent, targetAudience: value })
                      }
                    >
                      <SelectTrigger>
            ...
            <Dialog
              open={isCreateHolidayOpen}
              onOpenChange={setIsCreateHolidayOpen}
            >
              <DialogTrigger asChild>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.todayEvents}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.thisMonthEvents}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.totalHolidays}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              শিক্ষাবর্ষ {dashboardData.academicCalendar.academicYear}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {new Date(
                    dashboardData.academicCalendar.startDate,
                  ).toLocaleDateString("bn-BD")}{" "}
                  -{" "}
                  {new Date(
                    dashboardData.academicCalendar.endDate,
                  ).toLocaleDateString("bn-BD")}
                </p>
              </div>
              <div>
              ...
              {dashboardData.upcomingHolidays.map((holiday) => (
                <div key={holiday.id} className="border rounded-lg p-4">
                  ...
                  <div className="text-xs text-gray-500">
                    <span>
                      {new Date(holiday.startDate).toLocaleDateString("bn-BD")}
                    </span>
                    {holiday.startDate !== holiday.endDate && (
                      <span>
                        {" "}
                        -{" "}
                        {new Date(holiday.endDate).toLocaleDateString("bn-BD")}
                      </span>
                    )}
                  </div>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              সকল ইভেন্টের তালিকা এবং বিস্তারিত তথ্য
            </CardDescription>
          </CardHeader>
          <CardContent>
