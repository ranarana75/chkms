      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              অনলাইন ভর্তি আবেদন এবং নির্বাচন প্রক্রিয়া
            </p>
          </div>
          <Dialog
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.selectedStudents}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.paidApplications}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.totalSeats}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardData.stats.availableSeats}
                  </p>
                </div>
              </div>
            </CardContent>
                  ...
                  <div key={application.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                      <div>
                        ...
                        {getClassText(application.classAppliedFor)}
                      </div>
                      <div>
                        <span className="font-medium">আবেদনের তারিখ:</span>{" "}
                        {new Date(
                  ...
                  <div key={test.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                      <div>
                        ...
                        {new Date(test.testDate).toLocaleDateString("bn-BD")}
                      </div>
                      <div>
        ...
        {dashboardData.activeSession && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {dashboardData.activeSession.name}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {dashboardData.activeSession.academicYear}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {new Date(
                      dashboardData.activeSession.startDate,
                    ).toLocaleDateString("bn-BD")}{" "}
                    -{" "}
                    {new Date(
                      dashboardData.activeSession.endDate,
                    ).toLocaleDateString("bn-BD")}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    ৳{dashboardData.activeSession.applicationFee}
                  </p>
                </div>
                <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              সকল ভর্তি আবেদনের তালিকা এবং বিস্তারিত তথ্য
            </CardDescription>
          </CardHeader>
          <CardContent>
