  ...
  const login = async (
    ...
    try {
      ...
      if (!credentials.username || !credentials.password) {
        return {
          success: false,
          message: "ব্যবহারকারী নাম এবং পাসওয়ার্ড প্রয়োজন",
        };
      }
      ...
      if (!foundUser) {
        return {
          success: false,
          message: "ভুল ব্যবহারকারী নাম বা ব্যবহারকারীর ধরন",
        };
      }
      ...
      const sessionDuration = credentials.rememberMe
        ? 30 * 24 * 60 * 60 * 1000
        : 8 * 60 * 60 * 1000; // 30 days or 8 hours
      const now = new Date();
      ...
      return {
        success: false,
        message: "লগইনে সমস্যা হয়েছে। পুনরায় চেষ্টা করুন।",
      };
    } finally {
      setIsLoading(false);
    }
